...
function About() {
  ...
  return (
    <main>
      ...
      <ChallengesSection>
        <ChallengeIcon>
          {frontmatter.fourthSectionItems.map(item => {
            return (
              <div key={item.header}>
        ...
        <span className="title-description">
          <h2>{frontmatter.fourthSectionTitle}</h2>
          <p>{frontmatter.fourthSectionDescription}</p>
        </span>
      </ChallengesSection>
      ...
      <RebuildSection>
        <RebuildContent>
          <span className="title-description">
            ...
            <p>{frontmatter.thirdSectionDescription}</p>
          </span>

          <span>
            {frontmatter.thirdSectionItems.map(s => (
